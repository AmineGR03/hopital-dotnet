...
{
    /// <inheritdoc />
    public partial class InitialHospitalModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doctors_AspNetUsers_UtilisateurId",
            ...
            migrationBuilder.CreateTable(
                name: "HistoriquesMedicaux",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GroupeSanguin = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Allergies = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PatientId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoriquesMedicaux", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoriquesMedicaux_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoriqueMedicalId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiagnosticsPasses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiagnosticsPasses_HistoriquesMedicaux_HistoriqueMedicalId",
                        column: x => x.HistoriqueMedicalId,
                        principalTable: "HistoriquesMedicaux",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiagnosticsPasses_HistoriqueMedicalId",
                table: "DiagnosticsPasses",
                column: "HistoriqueMedicalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoriquesMedicaux_PatientId",
                table: "HistoriquesMedicaux",
                column: "PatientId",
                unique: true,
